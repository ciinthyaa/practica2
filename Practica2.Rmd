...
# Creamos una tabla con la frecuencia de los distintos tipos de error por código
tabla_tipos_errores <- table(epa_http$`Código de respuesta`)

# Mostramos los datos de las dos tablas anteriores
print(tabla_frecuencias)
print(tabla_tipos_errores)
...
# Creamos un gráfico de barras de los datos por IP y error
