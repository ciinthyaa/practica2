...
(epa_http$`Código de respuesta`>=400) & (epa_http$`Código de respuesta`<600)
errores<-subset(epa_http, epa_http[,'Código de respuesta'] >= "400")
errores$IPs<- as.factor(errores$IPs)
errores$'Código de respuesta'<- as.factor(errores$'Código de respuesta')
summary(errores)
```
